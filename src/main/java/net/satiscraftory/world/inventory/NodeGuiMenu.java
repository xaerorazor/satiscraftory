...
public class NodeGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NodeGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SatiscraftoryModMenus.NODE_GUI, id);
